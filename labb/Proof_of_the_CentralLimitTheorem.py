...
"""
Labb together with Anna-Maria 
Transformed from jupyter notebook to python script
"""

# Exercise 1.1
rnd_sample = np.random.randint(4, 8, 5)
# Creates a random sample, consisting of five observations (with the values 4, 5, 6, and/or 7)
...
def plot_z_scores(sample_size):
    ...
    plt.hist(z_scores, bins=20, density=True)
    # density is set to True so that the normal distribution line will follow the data
